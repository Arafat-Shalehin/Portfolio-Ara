        ...
        <section className="section-spacing c-space">
            ...
            md:auto-rows-[18rem] mt-12">
                ...
                <div className="flex items-end grid-default-color grid-1">
                    ...
                    />
                    <div className="z-10">
                        <p className="headtext">Hi, I'm Arafat Shalehin</p>
                        <p className="subtext">
                            Over the years, I developed my frontend dev skills
                            to make dynamic and responsive web applications.
                        </p>
                    </div>
                ...
                <div className="grid-default-color grid-2">
                    ...
                    h-full">
                        ...
                        text="GRASP"
                        containerRef={grid2Container}></Card>
                        <Card
                ...
                <div className="grid-black-color grid-3">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">I'm based in Bangladesh, and open to remote work
                            worldwide
                        </p>
                    </div>
                ...
                <div className="grid-default-color grid-5">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">
                            I specialize in a variety of languages, framesworks,
                            and tools that allow me to build robust and scalable applications
                        </p>
                    </div>
